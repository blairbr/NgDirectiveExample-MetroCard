...
export class MetroCardComponent implements OnInit {
  ...
  public metroCards : MetroCard[] = [{owner: "Blair", balance: 20, isActive: false}, {owner: 'Sputnik', balance: 0, isActive: true}, {owner: 'Freddie', balance: 3.5, isActive: true}, {owner:'Luca', balance: -1.90, isActive: true}];
  // stylesList: object = {
